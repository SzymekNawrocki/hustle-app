export default function DashboardPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-white">Witaj w HustleOS</h1>
        <p className="text-gray-400 mt-2">Oto podsumowanie Twoich postępów.</p>
      </div>
      ...
      <div className="h-96 bg-[#111114] border border-white/5 rounded-2xl flex items-center justify-center">
        <p className="text-gray-600">Nadchodzący wykres aktywności...</p>
      </div>
    </div>
  );
}
