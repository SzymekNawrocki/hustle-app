            ...
            <div className="text-center max-w-4xl mx-auto space-y-8">
              <div className="flex justify-center mb-12 animate-in fade-in zoom-in duration-1000 relative">
                ...
                <Image 
                  ...
                  width={200} 
                  height={100} 
                  className="rounded-3xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.6)] border border-border/60 transform hover:scale-[1.01] transition-all duration-700"
                  priority
                />
              </div>

              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card/60 border border-border/60 shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <p className="text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 font-sans">
